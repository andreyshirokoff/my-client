        ...
        <div class="info-container">
            <div class="d-flex flex-column flex-md-row justify-content-start column-gap-5 mb-2">
                <div>
                    ...
                    <p class="fs-5 mb-1">Kateryna Portenko</p>
                    <p class="fs-5 mb-1">Właściciel</p>
                </div>
                <div>
                    <p class="fs-4 fw-semibold mb-1">Telefon</p>
                    <p class="fs-5">+480 865 85 65</p>
                </div>
            </div>
            <p class="fs-4 fw-semibold mb-1">Email</p>
            <p class="fs-5">Katerynaportenkova@gmail.com</p>
            ...
            <a class="btn btn-dark rounded-pill" id="change-pwd-btn">Zmień hasło</a>
        </div>
    </div>
