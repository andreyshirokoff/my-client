...
class Packet extends Resource
{
     ...
     *
     * @var class-string<\App\Models\Packet>
     */
    public static $model = \App\Models\Packet::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Number::make('Cena', 'price')->sortable()
                ->rules('required'),
            Number::make('Cena za sztukę', 'price_for_item')->sortable()
                ->rules( 'required'),
            Number::make('Ilość','quantity')->sortable()
                ->rules('required'),
